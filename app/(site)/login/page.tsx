  ...
  return (
    <div className="mx-auto flex max-w-sm flex-col gap-6 py-14">
      ...
      {step === 'login' && (
        ...
        >
          <div>
            <p className="font-heading text-sm font-semibold text-ink">New to WE Bohra?</p>
            <p className="font-body text-xs text-ink-soft">Create your account in a minute.</p>
          </div>
